...
// ADMIN-SIGNATURE-01: Utilities landing now links to Signature Management.
// Admin-gated, matching the admin-tools module grid. Sales and viewer do not
// see the utilities cards.

const tools = [
  {
    title: "Signature Management",
    description: "Upload and manage signature images for admin use.",
    href: "/dashboard/admin-tools/utilities/signatures",
    icon: PenLine,
  },
];
...
export default async function UtilitiesPage() {
  ...
  if (!isAdmin) {
    return (
      <div>
        <div className="mb-8">
          <h1 className="text-2xl font-semibold text-zinc-900">Utilities</h1>
        </div>
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-zinc-900">Utilities</h1>
        <p className="mt-1 text-sm text-zinc-500">Admin utilities</p>
      </div>
